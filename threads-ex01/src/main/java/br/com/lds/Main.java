...
public class Main {
	...
	private void start() {
		Caminhao primeiroCaminhao = new Caminhao("TiburssiusLog", 2);
		...
		System.out.println(
				"A aplicação está livre para trabalhar em outras coisas caso necessario enquanto as threads estao trabalhando");
	}
